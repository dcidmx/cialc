<style>
	...
	<section class="section-sm-50">
		<div class="shell">
			<ol class="breadcrumb">
			  ...
			  <li class="active">Solicitud de números</li>
			</ol>
		</div>
	</section>
    <section class="section-60 section-sm-top-90 section-sm-bottom-100">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
						<h4>Solicitud de números</h4>
						<br>
						<iframe src="http://docs.google.com/gview?url=<?=URL_PUBLIC?>frontend/images/cuadernos/atrasados.pdf&amp;embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
				</div>
			</div>
		</div>
    </section>
