<style>
	...
	<section class="section-sm-50">
        ...
        <li data-file="index" data-folder="cuadernos|epoca2" class="load-content">Primera Época (1987-2008)</li>
        <li class="active">BREADCRUMBSBREADCRUMBSBREADCRUMBSBREADCRUMBSBREADCRUMBSBREADCRUMBSBREADCRUMBSBREADCRUMBS</li>
			</ol>
		</div>
	</section>
    <section class="section-60 section-sm-top-90 section-sm-bottom-100">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<h4>TITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULOTITULO</h4>
            <iframe src="http://docs.google.com/gview?url=<?=URL_PUBLIC?>frontend/images/cuadernos/ARCHIVOPDFARCHIVOPDFARCHIVOPDFARCHIVOPDFARCHIVOPDFARCHIVOPDF&amp;embedded=true" style="width:100%; height:500px;" frameborder="0"></iframe>
				</div>
			</div>
		</div>
    </section>
