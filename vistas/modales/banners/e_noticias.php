		...
		<div class="modal-content">
                              ...
                              <div class="col-md-6">
                                     <?php if(!$ban->url_full){ ?>
                                            <div id="banner_actual">
                                                <img src="http://ipsumimage.appspot.com/285x190?l=585x290" class="img-responsive" alt="">
          			                            </div>
                                     <?php }else{ ?>
                                            <div id="banner_actual">
                                                <img src="plugs/timthumb.php?src=content/banners/noticias/<?=$ban->url_full?>&w=280"  alt="">
          			                            </div>
                                     <?php } ?>
                              </div>
                              <div class="col-md-6">
          ...
          <input type="hidden" id="id" name="id" value="<?=$ban->id?>">
					...
					<div class="modal-footer">
						<button  class="btn btn-ar btn-success" type="button" onclick="editar_banner_noti();">Guardar</button>
                     ...
                     <script>
										 $(document).ready(function() {
											 $("#m-dropzone-one").dropzone({
												 url: "bannernoticias/upload_dropzone/<?=$ban->id?>",
												 paramName: "file",
												 maxFiles: 1,
												 maxFilesize: 20, // MB 
												 acceptedFiles: "image/*",
												 ...
												 init: function() {
													 this.on("success", function(statics,file) {
														 var img = file.split("|");
														 $('#banner_actual').html('<center><img src="plugs/timthumb.php?src=content/banners/noticias/'+img[1]+'&w=230"></center>');
													 });
												 }
												});
										 });
