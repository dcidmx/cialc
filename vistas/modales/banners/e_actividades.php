		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal_content">
                ...
                <div class="col-md-12">
                              ...
                              <div class="col-md-6">
                                     <?php if(!$ban->url_full){ ?>
                                            <div id="banner_actual">
                                                <img src="http://ipsumimage.appspot.com/285x190?l=893x298" class="img-responsive" alt="">
          			                            </div>
                                     <?php }else{ ?>
                                            <div id="banner_actual">
                                                <img src="plugs/timthumb.php?src=content/banners/actividades/<?=$ban->url_full?>&w=280"  alt="">
          			                            </div>
                                     <?php } ?>
                              </div>
                              <div class="col-md-6">
                       ...
                       <div class="row">
                              <div class="col-md-6">
                                     <?php if(!$ban->poster_full){ ?>
                                            <div id="banner_actual2">
                                                <img src="http://ipsumimage.appspot.com/285x190?l=POSTER" class="img-responsive" alt="">
          			                            </div>
                                     <?php }else{ ?>
                                            <div id="banner_actual2">
                                                <img src="plugs/timthumb.php?src=content/banners/actividades/<?=$ban->poster_full?>&w=280"  alt="">
          			                            </div>
                                     <?php } ?>
                              </div>
                              <div class="col-md-6">
          ...
          <input type="hidden" id="id" name="id" value="<?=$ban->id?>">
					...
					<div class="modal-footer">
						<button  class="btn btn-ar btn-success" type="button" onclick="editar_banner_act();">Guardar</button>
	     ...
	     <script>
			 $(document).ready(function() {
				 $("#m-dropzone-one").dropzone({
					 url: "banneractividades/upload_dropzone/<?=$ban->id?>",
					 paramName: "file",
					 maxFiles: 1,
					 maxFilesize: 5, // MB
					 acceptedFiles: "image/*",
					 ...
					 init: function() {
						 this.on("success", function(statics,file) {
							 var img = file.split("|");
							 $('#banner_actual').html('<center><img src="plugs/timthumb.php?src=content/banners/actividades/'+img[1]+'&w=280"></center>');
						 });
					 }
					});
					...
					$("#m-dropzone-two").dropzone({
 					 ...
 					 init: function() {
 						 this.on("success", function(statics,file) {
 							 var img = file.split("|");
 							 $('#banner_actual2').html('<center><img src="plugs/timthumb.php?src=content/banners/actividades/'+img[1]+'&w=280"></center>');
 						 });
 					 }
 					});
