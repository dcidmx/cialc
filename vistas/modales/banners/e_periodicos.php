		...
		<div class="modal-content">
                              ...
                              <div class="col-md-6">
                                     <?php if(!$ban->url_full){ ?>
                                            <div id="banner_actual">
                                                <img src="http://ipsumimage.appspot.com/285x190?l=Tamaño+de+origen" class="img-responsive" alt="">
          			                            </div>
                                     <?php }else{ ?>
                                            <div id="banner_actual">
                                                <img src="plugs/timthumb.php?src=content/banners/periodicos/<?=$ban->url_full?>&w=280"  alt="">
          			                            </div>
                                     <?php } ?>
                              </div>
                              <div class="col-md-6">
          ...
          <input type="hidden" id="id" name="id" value="<?=$ban->id?>">
					...
					<div class="modal-footer">
						<button  class="btn btn-ar btn-success" type="button" onclick="editar_banner_news();">Guardar</button>
											 ...
											 $("#m-dropzone-one").dropzone({
												 ...
												 init: function() {
													 this.on("success", function(statics,file) {
														 var img = file.split("|");
														 $('#banner_actual').html('<center><img src="plugs/timthumb.php?src=content/banners/periodicos/'+img[1]+'&w=280"></center>');
													 });
												 }
												});
										 });
