		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					Añadir nuevo banner de novedades:
				</h4>
			</div>
			<div class="modal-body" id="modal_content">
                ...
                <div class="col-md-12">
                       <div class="row">
                              ...
                              <div class="col-md-12">
                                     <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="url_link" name="url_link" placeholder="URL Libros UNAM">
                                     </div>
                              </div>
                       </div>
                       <div class="row">
					...
					<div class="modal-footer">
						<button  class="btn btn-ar btn-success" type="button" onclick="guardar_banner_nov();">Agregar</button>
