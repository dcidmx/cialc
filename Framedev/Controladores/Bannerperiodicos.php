<?php
class Bannerperiodicos extends Controlador
{
    public function index()
    {
	     $this->se_requiere_logueo(true,'Bannerperiodicos|index');
       require URL_VISTA.'banners/periodicos.php';
    }

    public function obtener_banners()
    {
	     $this->se_requiere_logueo(true,'Bannerperiodicos|index');
       $modelo = $this->loadModel('Bannerperiodicos');
       print $modelo->obtener_banners($_POST);
    }

    public function agregar_banner()
    {
	     $this->se_requiere_logueo(true,'Bannerperiodicos|agregar_banner');
       require URL_VISTA.'modales/banners/a_periodicos.php';
    }

    public function editbanner($id)
    {
	     $this->se_requiere_logueo(true,'Bannerperiodicos|editbanner');
       $model = $this->loadModel('Bannerperiodicos');
       $elm = $model->data_element($id);
       require URL_VISTA.'modales/banners/e_periodicos.php';
    }
    ...
    public function upload_dropzone($id){
        ...
        $upload_dir = '../public/content/banners/periodicos/';
        ...
        if(((strpos($_FILES['file']['type'], 'image') !== false) ||
          ...
          if(move_uploaded_file($pic['tmp_name'], $destino_final)){
            ...
            $set_image = $this->loadModel('Bannerperiodicos');
