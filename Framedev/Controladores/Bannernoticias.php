<?php
class Bannernoticias extends Controlador
{
    public function index()
    {
	     $this->se_requiere_logueo(true,'Bannernoticias|index');
       require URL_VISTA.'banners/noticias.php';
    }

    public function obtener_banners()
    {
	     $this->se_requiere_logueo(true,'Bannernoticias|index');
       $modelo = $this->loadModel('Bannernoticias');
    ...
    public function agregar_banner()
    {
       ...
       require URL_VISTA.'modales/banners/a_noticias.php';
    }

    public function editbanner($id)
    {
	     $this->se_requiere_logueo(true,'Bannernoticias|editbanner');
       $model = $this->loadModel('Bannernoticias');
       $elm = $model->data_element($id);
       require URL_VISTA.'modales/banners/e_noticias.php';
    }
    ...
    public function upload_dropzone($id){
        $this->se_requiere_logueo(true,'Bannernoticias|agregar_banner');
        $upload_dir = '../public/content/banners/noticias/';
        ...
        if(((strpos($_FILES['file']['type'], 'image') !== false) ||
          ...
          if(move_uploaded_file($pic['tmp_name'], $destino_final)){
            ...
            $set_image = $this->loadModel('Bannernoticias');
