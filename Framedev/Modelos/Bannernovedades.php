...
class BannernovedadesModel
{
    ...
    function get_banners(){
      $elm="SELECT * FROM cialc_banner_nov as ban WHERE ban.status = 3 ORDER BY orden ASC";
      $query = $this->db->prepare($elm);
      $query->execute();
      return $query->fetchAll();
    }

    function get_banners_page(){
      $elm="SELECT * FROM cialc_banner_nov as ban";
      $query = $this->db->prepare($elm);
      $query->execute();
      return $query->fetchAll();
    }
    ...
    public function data_element($id){
             $elm="SELECT * FROM cialc_banner_nov as ban WHERE ban.id = $id";
             $query = $this->db->prepare($elm);
             $query->execute();
             return $query->fetchAll();
    }
    ...
    public function editbanner_do($arreglo){
           ...
           $sql = "UPDATE cialc_banner_nov SET
                            name = '".$this->name."',
    ...
    public function obtener_banners($array){
      ...
      $table = 'cialc_banner_nov as banner';
