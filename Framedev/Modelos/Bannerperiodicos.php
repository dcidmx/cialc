...
class BannerperiodicosModel
{
    ...
    function get_banners(){
      $elm="SELECT * FROM cialc_banner_news as ban WHERE ban.status = 3 ORDER BY orden ASC";
    ...
    public function data_element($id){
             $elm="SELECT * FROM cialc_banner_news as ban WHERE ban.id = $id";
             $query = $this->db->prepare($elm);
             $query->execute();
             return $query->fetchAll();
    }
    ...
    public function editbanner_do($arreglo){
           ...
           $sql = "UPDATE cialc_banner_news SET
                            name = '".$this->name."',
    ...
    public function obtener_banners($array){
      ...
      $table = 'cialc_banner_news as banner';
